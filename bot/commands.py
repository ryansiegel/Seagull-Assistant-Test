        ...
        if (ranks-4) <= count and count <= ranks:
            if prefix.endswith('.speciesName'):
                ...
                if event == 'end_map':
                    ...
                    with open('bot/pvpoke/movesets/fighting') as file:
                        for item in file:
                            if item.replace("\n","") == chargemove[0]:
                                chargemove[0] = "<:fight:919750721627365417>" + chargemove[0]
                            if item.replace("\n","") == chargemove[1]:
                                chargemove[1] = "<:fight:919750721627365417>" + chargemove[1]
                            if item.replace("\n","") == fastmove:
                                fastmove = "<:fight:919750721627365417>" + fastmove
                    with open('bot/pvpoke/movesets/dragon') as file:
                        for item in file:
                            if item.replace("\n","") == chargemove[0]:
                                chargemove[0] = "<:dragon:919750721635758100>" + chargemove[0]
                            if item.replace("\n","") == chargemove[1]:
                    ...
                    with open('bot/pvpoke/movesets/steel') as file:
                        for item in file:
                            if item.replace("\n","") == chargemove[0]:
                                chargemove[0] = "<:steel:919750721593827358>" + chargemove[0]
                            if item.replace("\n","") == chargemove[1]:
                                chargemove[1] = "<:steel:919750721593827358>" + chargemove[1]
                            if item.replace("\n","") == fastmove:
                                fastmove = "<:steel:919750721593827358>" + fastmove
                    with open('bot/pvpoke/movesets/bug') as file:
                        for item in file:
                            if item.replace("\n","") == chargemove[0]:
                                chargemove[0] = "<:bug:919749820401479731>" + chargemove[0]
                            if item.replace("\n","") == chargemove[1]:
                                chargemove[1] = "<:bug:919749820401479731>" + chargemove[1]
                            if item.replace("\n","") == fastmove:
                                fastmove = "<:bug:919749820401479731>" + fastmove
                    with open('bot/pvpoke/movesets/psychic') as file:
                        for item in file:
                            if item.replace("\n","") == chargemove[0]:
                                chargemove[0] = "<:psychic:919750721488965712>" + chargemove[0]
                            if item.replace("\n","") == chargemove[1]:
                    ...
                    with open('bot/pvpoke/movesets/normal') as file:
                        for item in file:
                            if item.replace("\n","") == chargemove[0]:
                                chargemove[0] = "<:normal:919750721635745852>" + chargemove[0]
                            if item.replace("\n","") == chargemove[1]:
                                chargemove[1] = "<:normal:919750721635745852>" + chargemove[1]
                            if item.replace("\n","") == fastmove:
                                fastmove = "<:normal:919750721635745852>" + fastmove
                    with open('bot/pvpoke/movesets/poison') as file:
                        for item in file:
                            if item.replace("\n","") == chargemove[0]:
                                chargemove[0] = "<:poison:919750721648332810>" + chargemove[0]
                            if item.replace("\n","") == chargemove[1]:
                                chargemove[1] = "<:poison:919750721648332810>" + chargemove[1]
                            if item.replace("\n","") == fastmove:
                                fastmove = "<:poison:919750721648332810>" + fastmove
                    if XL == True:
